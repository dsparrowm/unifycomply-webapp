    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(300px,380px)]">
      <div className="rounded-xl border border-[color:var(--border-default)] bg-[color:var(--bg-surface)]">
        <div className="flex items-center justify-between border-b border-[color:var(--border-default)] px-6 py-5">
          ...
          <span className="inline-flex items-center rounded-md border border-[color:var(--state-success)] px-2.5 py-0.5 text-xs font-semibold uppercase tracking-wide text-[color:var(--state-success)]">
        ...
        <div className="space-y-8 px-6 py-6">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="space-y-1.5">
              ...
              <p className="text-sm font-semibold uppercase tracking-wide text-[color:var(--state-success)]">
                {detail.registryStatus}
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl bg-[color:var(--bg-muted)] p-5">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              {detail.businessActivities.map((activity) => (
                <span
                  key={activity}
                  className="inline-flex items-center rounded-lg border border-[color:var(--accent-primary-hover)]/30 bg-[color:var(--accent-primary-soft)] px-3 py-1.5 text-sm text-[color:var(--accent-primary)]"
                >
                  {activity}
                </span>
              ))}
