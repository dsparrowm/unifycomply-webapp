...
import type { AmlEscalateSummary } from "@/types/aml";

type AmlEscalateModalProps = {
  open: boolean;
  summary: AmlEscalateSummary;
  onClose: () => void;
  onConfirm: (notes: string) => void;
};

export function AmlEscalateModal({ open, summary, onClose, onConfirm }: AmlEscalateModalProps) {
