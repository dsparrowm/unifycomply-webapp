...
import {
  tmCategoryFilterOptions,
  tmDateFilterOptions,
  tmMoreFilterOptions,
  tmStatusFilterOptions,
} from "@/lib/data/transaction-filters";
import type { TmListFilters } from "@/types/transaction-monitoring";

type FilterKey = "date" | "status" | "category" | "more";

type TransactionsFiltersProps = {
  filters: TmListFilters;
  onFiltersChange: (filters: TmListFilters) => void;
  searchQuery: string;
...
export function TransactionsFilters({
  ...
  const updateFilter = <K extends keyof TmListFilters>(
    key: K,
    value: TmListFilters[K],
  ) => {
  ...
  return (
    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <KycFilterDropdown
          label="Category"
          options={tmCategoryFilterOptions}
