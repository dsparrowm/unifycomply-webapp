  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="tm-escalate-title"
      ...
      >
        ...
        >
          <p className="text-sm text-[color:var(--text-primary)]">
            Escalate <span className="font-medium">{customerName}</span> (
            {transactionId}) to a senior compliance officer for further assessment.
          </p>

          <div className="space-y-2">
            <label
              htmlFor="tm-escalate-notes"
              className="text-sm font-medium text-[color:var(--text-primary)]"
            >
              Escalation notes
            </label>
            <textarea
              id="tm-escalate-notes"
              rows={4}
              required
              value={notes}
